...
REM TCP
REM NETSH ADVFIREWALL FIREWALL ADD RULE ACTION="ALLOW" DIR="IN" NAME="HTTP"  PROTOCOL="TCP" LOCALPORT="80,8000,8080,8100,8888"
REM NETSH ADVFIREWALL FIREWALL ADD RULE ACTION="ALLOW" DIR="IN" NAME="IMAP"  PROTOCOL="TCP" LOCALPORT="143"
REM NETSH ADVFIREWALL FIREWALL ADD RULE ACTION="ALLOW" DIR="IN" NAME="HTTPS" PROTOCOL="TCP" LOCALPORT="443"
